...
class YOLOV5():
    def __init__(self,onnxpath, classes, conf_thresh=0.8, iou_threshold=0.6):
...
if __name__ == "__main__":
    ...
    classes = [ 'Banana Peel','Broken Bones', 'Cigarette End', 'Disposable Chopsticks',
